...
namespace Worktop.Models.Domain
{
    public class User : IdentityUser<int>
    {
        ...
        public ICollection<Models.Domain.File> Files { get; set; } = new HashSet<File>();
        public ICollection<Models.Domain.Directory> Directories { get; set; } = new HashSet<Directory>();
